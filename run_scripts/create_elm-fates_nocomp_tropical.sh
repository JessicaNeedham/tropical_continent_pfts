...
export TAG='nocomp_fates_tropical'
...
fsurdat = '/global/homes/j/jneedham/tropical-fixed-biog/domainsurf/surf_nocomp.nc'
fates_paramfile='/global/homes/j/jneedham/tropical-fixed-biog/param_files/v3/fates_params_calibrated_api40_nocomp_tropics.nc'
