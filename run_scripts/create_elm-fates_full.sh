...
export TAG='full_fates_test5_short'
...
#./xmlchange JOB_WALLCLOCK_TIME=4:58:00
...
fates_paramfile='/global/homes/j/jneedham/tropical-fixed-biog/param_files/fates_params_tropical_allometries_api38.nc'
...
'FATES_VEGC_PF','FATES_VEGC_ABOVEGROUND_SZPF', 'FATES_DDBH_SZPF', 'FATES_NPLANT_SZPF','FATES_ZSTAR_AP', 
 'FATES_CROWNAREA_PF', 'FATES_RECRUITMENT_PF',
