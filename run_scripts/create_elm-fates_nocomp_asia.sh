...
./xmlchange LND_DOMAIN_FILE=asia_domain.nc
./xmlchange LND_DOMAIN_PATH=/global/homes/j/jneedham/tropical-fixed-biog/domainsurf
./xmlchange ATM_DOMAIN_FILE=asia_domain.nc
...
fsurdat = '/global/homes/j/jneedham/tropical-fixed-biog/domainsurf/asia_surf.nc'
fates_paramfile='/global/homes/j/jneedham/tropical-fixed-biog/param_files/v2/fates_params_asia.nc'
