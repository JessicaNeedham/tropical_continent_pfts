...
fsurdat = '/global/homes/j/jneedham/tropical-fixed-biog/domainsurf/americas_surf.nc'
fates_paramfile='/global/homes/j/jneedham/tropical-fixed-biog/param_files/v2/fates_params_americas.nc'
